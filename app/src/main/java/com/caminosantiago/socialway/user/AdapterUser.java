...
import com.caminosantiago.socialway.home.MapsActivity;
import com.caminosantiago.socialway.home.PagerAdapterPublication;
 ...
 */
public class AdapterUser extends ArrayAdapter<Publication> {
    ...
    public AdapterUser(OnInteractionHome callback,Activity context, List<Publication> contenido, List<Integer> listFavourites) {
        super(context, R.layout.item_user, contenido);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (data.getListImages().size()==0){
            ...
            PagerAdapterPublication adapter = new PagerAdapterPublication(context,data.getListImages());
